...
mtw.default.areas = {
["generic"] = {level = "", krondor = "none", targets = {"an ethereal mana wyrm", "a tiny pumpkin", "a little pumpkin", "a small pumpkin", "a medium pumpkin", "a mature pumpkin", "a big pumpkin", "a huge pumpkin", "a monstrous pumpkin",  "a time%-displaced glamredhel archer", "a time%-displaced glamredhel warrior"}, items = {"a mote of glowing%, blue mana"}},
...
["the Thunderhell Plains"] = {level = "60-100", krondor = "extremely far to the north", targets = {"a tufted eared lynx", "a polar bear", "a female polar bear", "a large salmon", "a bison", "an antlered caribou", "a caribou"}},
