...
function mtw.loaddefaultaliases()
 ...
 mtw.adddefaultalias("mt_is", "Ice Spikes", "b", "ice", "cast icespikes #T")
 mtw.adddefaultalias("mt_sto", "Stormlance", "b", "sto", "cast stormlance #T")
 mtw.adddefaultalias("mt_sky", "Skylash", "b", "sky", "cast skylash #T")
 mtw.adddefaultalias("mt_chi", "Chill", "b", "chi", "cast chill #T")
 mtw.adddefaultalias("mt_sht", "Shatter", "b", "sht", "cast shatter #T")
 mtw.adddefaultalias("mt_ign", "Ignite", "b", "ign", "cast ignite #T")
 mtw.adddefaultalias("mt_imm", "Immolate", "b", "imm", "cast immolate #T")
 mtw.adddefaultalias("mt_eb", "Earthbind", "b", "ebi", "cast earthbind #T")
 mtw.adddefaultalias("mt_eq", "Earthquake", "b", "equ", "cast earthquake")
 mtw.adddefaultalias("mt_sd", "Static Discharge", "b", "sdis", "cast discharge #T")
 mtw.adddefaultalias("mt_gl", "Gale", "b", "gale", "cast gale #T #D")
 mtw.adddefaultalias("mt_sw", "Stillwater", "b", "swater", "cast stillwater")
 mtw.adddefaultalias("mt_py", "Pyroclasm", "b", "pyro", "cast pyroclasm #D")
 mtw.adddefaultalias("mt_kk", "Kelton's Knives", "b", "kni", "cast kelton's knives")
 mtw.adddefaultalias("mt_ft", "Frozen Tomb", "b", "fto", "cast entomb #T")
 mtw.adddefaultalias("mt_iw", "Icewall", "b", "iwa", "cast icewall #D")
 mtw.adddefaultalias("mt_fw", "Firewall", "b", "fwa", "cast firewall #D")
 mtw.adddefaultalias("mt_ml", "Magelock", "b", "mlo", "cast magelock #D")
 mtw.adddefaultalias("mt_ic", "Incinerate", "b", "inci", "cast incinerate #T")
 mtw.adddefaultalias("mt_shd", "Shadows", "b", "shd", "cast shadows")
 mtw.adddefaultalias("mt_fld", "Flood", "b", "flood", "cast flood")
 mtw.adddefaultalias("mt_fz", "Freeze", "b", "frz", "cast freeze")
 mtw.adddefaultalias("mt_lb", "Lightball", "b", "lball", "cast lightball")
 mtw.adddefaultalias("mt_ls", "Lodestone", "b", "lode", "cast lodestone")
 mtw.adddefaultalias("mt_es1", "Elemental Shield", "b", "elea", "cast elementshield arcane")
 mtw.adddefaultalias("mt_es2", "Elemental Shield", "b", "elef", "cast elementshield fire")
 mtw.adddefaultalias("mt_es3", "Elemental Shield", "b", "elet", "cast elementshield frost")
 mtw.adddefaultalias("mt_es4", "Elemental Shield", "b", "elec", "cast elementshield electric")
 mtw.adddefaultalias("mt_ww", "Windweave", "b", "weave", "cast windweave")
 mtw.adddefaultalias("mt_wb", "Waterbreathing", "b", "wat", "cast waterbreathing")
 mtw.adddefaultalias("mt_wb2", "Waterbreathing", "b", "watt", "cast waterbreathing #T", "Waterbreathing - target")
 mtw.adddefaultalias("mt_lv", "Levitate", "b", "levi", "cast levitate")
 mtw.adddefaultalias("mt_sf1", "Stormfury", "b", "sfon", "stormfury embrace", "Embrace stormfury")
 mtw.adddefaultalias("mt_sf2", "Stormfury", "b", "sfoff", "stormfury release", "Release stormfury")
 mtw.adddefaultalias("md_cir", "Summoning Circle", "b", "scir", "draw summoning circle")
 mtw.adddefaultalias("md_ath", "Sacrificial Athame", "b", "sathame", "summon athame")
 mtw.adddefaultalias("md_dp1", "Dark Pact", "b", "p1", "pact demon with threats", "Pact with threats")
 mtw.adddefaultalias("md_dp2", "Dark Pact", "b", "p2", "pact demon with manipulation", "Pact with manipulation")
 mtw.adddefaultalias("md_dp3", "Dark Pact", "b", "p3", "pact demon with power", "Pact with power")
 mtw.adddefaultalias("md_bn", "Banish", "b", "ban", "banish demon")
 mtw.adddefaultalias("md_sc", "Shadowcloak", "b", "scloak", "demoncall shadowcloak")
 mtw.adddefaultalias("md_ba", "Black Augury", "b", "aug", "demoncall augury")
 mtw.adddefaultalias("md_ht", "Howl of Terror", "b", "ht", "demoncall howl")
 mtw.adddefaultalias("md_wh", "Wild Hunt", "b", "hunt", "demoncall hunt #T")
 mtw.adddefaultalias("md_sd", "Seduce", "b", "sed", "demoncall seduce #T")
 mtw.adddefaultalias("md_nm", "Nightmare", "b", "nmare", "demoncall nightmare #T")
 mtw.adddefaultalias("md_w1", "Blood Wrath", "b", "reck", "blood wrath recklessness #T", "Blood Wrath - Recklessness")
 mtw.adddefaultalias("md_w2", "Blood Wrath", "b", "dyst", "blood wrath dystonia #T", "Blood Wrath - Dystonia")
 mtw.adddefaultalias("md_w3", "Blood Wrath", "b", "asth", "blood wrath asthma #T", "Blood Wrath - Asthma")
 mtw.adddefaultalias("md_w4", "Blood Wrath", "b", "amn", "blood wrath amnesia #T", "Blood Wrath - Amnesia")
 mtw.adddefaultalias("md_w5", "Blood Wrath", "b", "fbolt", "blood wrath firebolt #T", "Blood Wrath - Firebolt")
 mtw.adddefaultalias("md_w6", "Blood Wrath", "b", "sens", "blood wrath sensitivity #T", "Blood Wrath - Sensitivity")
 mtw.adddefaultalias("md_w7", "Blood Wrath", "b", "cata", "blood wrath cataplexy #T", "Blood Wrath - Cataplexy")
 mtw.adddefaultalias("md_w8", "Blood Wrath", "b", "anem", "blood wrath anemia #T", "Blood Wrath - Anemia")
 mtw.adddefaultalias("md_w9", "Blood Wrath", "b", "hache", "blood wrath headache #T", "Blood Wrath - Headache")
 mtw.adddefaultalias("md_w10", "Blood Wrath", "b", "impa", "blood wrath impatience #T", "Blood Wrath - Impatience")
 mtw.adddefaultalias("md_w11", "Blood Wrath", "b", "conf", "blood wrath confusion #T", "Blood Wrath - Confusion")
 mtw.adddefaultalias("md_w12", "Blood Wrath", "b", "atax", "blood wrath ataxia #T", "Blood Wrath - Ataxia")
 mtw.adddefaultalias("md_w13", "Blood Wrath", "b", "mala", "blood wrath maladroitness #T", "Blood Wrath - Maladroitness")
 mtw.adddefaultalias("md_w14", "Blood Wrath", "b", "sslp", "blood wrath sleep #T", "Blood Wrath - Sleep")
 mtw.adddefaultalias("md_w15", "Blood Wrath", "b", "wdre", "blood wrath dreams #T", "Blood Wrath - Waking dreams")
 mtw.adddefaultalias("md_w16", "Blood Wrath", "b", "conc", "blood wrath concussion #T", "Blood Wrath - Concussion")
 mtw.adddefaultalias("md_w17", "Blood Wrath", "b", "epil", "blood wrath epilepsy #T", "Blood Wrath - Epilepsy")
 mtw.adddefaultalias("md_w18", "Blood Wrath", "b", "dign", "blood wrath ignite #T", "Blood Wrath - Ignite")
 mtw.adddefaultalias("md_w19", "Blood Wrath", "b", "claw", "blood wrath claw #T", "Blood Wrath - Claw")
 mtw.adddefaultalias("md_w20", "Blood Wrath", "b", "fball", "blood wrath fireball #T", "Blood Wrath - Fireball")
 mtw.adddefaultalias("md_sm", "Imp", "b", "smn", "summon #T", "Summon demon")
 mtw.adddefaultalias("md_bf", "Blood Feast", "b", "feast", "demoncall feast #T")
 mtw.adddefaultalias("md_wl", "Witchsight", "b", "wsl", "witchsight look", "Witchsight look")
 mtw.adddefaultalias("md_sl", "Soul Link", "b", "sl", "demoncall soullink")
 mtw.adddefaultalias("md_bc", "Blood Command", "f", "bc #.", "blood_command")
 mtw.adddefaultalias("md_tt", "Torture", "b", "tor", "demoncall torture #T")
 mtw.adddefaultalias("md_sf", "Sacrifice", "b", "sac", "sacrifice demon")
 mtw.adddefaultalias("md_bh", "Blood Harvest", "b", "bhar", "demoncall harvest demon")
 mtw.adddefaultalias("md_ssh", "Soul Trap", "b", "ssh", "soultrap shatter", "Shatter Soultrap")
 mtw.adddefaultalias("md_sst", "Soul Trap", "b", "sst", "vout heartstone;soultrap demon")
 mtw.adddefaultalias("md_sb", "Scabies", "b", "scab", "demoncall scabies #T")
 mtw.adddefaultalias("md_np", "Necrotic Plague", "b", "plg", "demoncall plague #T")
 mtw.adddefaultalias("md_dc1", "Dark Pact", "n", "odp", "order demon passive", "Order demon passive")
 mtw.adddefaultalias("md_dc2", "Dark Pact", "n", "oda", "order demon attack #T", "Order demon attack")
 mtw.adddefaultalias("md_dc3", "Blood Command", "b", "bca", "blood command attack #T", "Blood command attack")
 mtw.adddefaultalias("md_sp", "Dark Pact", "f", "sd #.", "summon_pact", "Summon and pact demon")
 mtw.adddefaultalias("md_au", "Black Augury", "f", "augury", "augury", "Summon, pact imp and augury")
 mtw.adddefaultalias("md_gt", "Demon Gate", "b", "dgate", "demoncall gate")
 mtw.adddefaultalias("md_ct", "Curse of Tongues", "b", "cot", "demoncall curse #T")
