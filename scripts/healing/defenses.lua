...
--Priest: Pyromania
def_flameborne = {defense = "aura of flames", type = "normal", effect = "fire damage protection and firewall immunity", skill = "Flameborne", balance = {needybalancetake = "firecall flameborne"}, state = "down", needit = false, timer = createStopWatch()},
--Priest: Shadoweaving
--Priest: Bloodlore
